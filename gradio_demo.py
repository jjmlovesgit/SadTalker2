...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', still_mode=False, use_enhancer=False, result_dir='./results/'):
        ...
        # Initialize coeff_path to None (Added 6/11 to make reference video pose work)
        coeff_path = None
...
# Our Section of addtional Code
        ...
        ref_eyeblink = "C:\\YourLoc\\mccor\\SadTalker\\ref_eyeblink_video.mp4"
        print(ref_eyeblink)

        ref_pose = "C:\\Users\\YourLoc\\SadTalker\\ref_pose_video.mp4"
        #ref_pose = None
        print(ref_pose)
        ...
        #audio2coeff
        batch = get_data(first_coeff_path, audio_path, self.device, ref_eyeblink_coeff_path, still=still_mode) # longer audio?  
        coeff_path = self.audio_to_coeff.generate(batch, save_dir, pose_style) 
        
# End of our section with addtional code        
